# 🧠 Machine Learning Lab – Core Algorithm Applications

This repository contains practical implementations of essential Machine Learning techniques using Python. The focus is on understanding the fundamentals of **data preprocessing, supervised & unsupervised learning**, and **dimensionality reduction** using clean, well-documented code and real datasets.
...
| 🔢 **ANN (Deep Learning)** | **Artificial Neural Network for image classification.** |
| 🔗 **Apriori Algorithm** | **Association Rule Mining to find frequent itemsets and rules.** |
...
* **MNIST Dataset** – Handwritten digits (for ANN).
...
* **Sample Transactions** - Custom list of transactions (for Apriori Algorithm).
...
| **ANN (Deep Learning)** | **Loss, Accuracy** |
